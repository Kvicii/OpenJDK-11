...
public class StandardCharsets extends CharsetProvider {
    ...
    @Stable
    private Map<String, String> classMap;       // [规范名-字符集类名]映射
    @Stable
    ...
    // [别名-规范名]映射系统
    private static final class Aliases extends sun.util.PreHashedMap<String> {
    ...
    // [规范名-字符集类名]映射
    private static final class Classes extends sun.util.PreHashedMap<String> {
