...
public interface IntStream
    ...
    static IntStream iterate(final int seed, final IntUnaryOperator f) {
        ...
        Spliterator.OfInt spliterator = new Spliterators.AbstractIntSpliterator(Long.MAX_VALUE, Spliterator.ORDERED | Spliterator.IMMUTABLE | Spliterator.NONNULL) {
            int prev;
            boolean started;
    ...
    default IntStream takeWhile(IntPredicate predicate) {
        ...
        return StreamSupport.intStream(new WhileOps.UnorderedWhileSpliterator.OfInt.Taking(spliterator(), true, predicate), isParallel()).onClose(this::close);
    }
    ...
    default IntStream dropWhile(IntPredicate predicate) {
        ...
        // Reuses the unordered spliterator, which, when encounter is present,
        // is safe to use as long as it configured not to split
        return StreamSupport.intStream(new WhileOps.UnorderedWhileSpliterator.OfInt.Dropping(spliterator(), true, predicate), isParallel()).onClose(this::close);
    }
