...
/**
 * Utility class for detecting inadvertent uses of boxing in {@code java.util} classes.
 * The detection is turned on or off based on whether the system property {@code org.openjdk.java.util.stream.tripwire} is considered {@code true}
 * according to {@link Boolean#getBoolean(String)}.
...
final class Tripwire {
    ...
    /**
     * Produces a log warning, using {@code PlatformLogger.getLogger(className)}, using the supplied message.
     * The class name of {@code trippingClass} will be used as the first parameter to the message.
     *
