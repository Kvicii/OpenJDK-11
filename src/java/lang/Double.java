...
public final class Double extends Number implements Comparable<Double> {
     ...
     */
    public static final double POSITIVE_INFINITY = 1.0 / 0.0; // 代表正无穷大
     ...
     */
    public static final double NEGATIVE_INFINITY = -1.0 / 0.0; // 代表负无穷大
     ...
     */
    public static final double NaN = 0.0d / 0.0; // 代表非数字
     ...
     * @since 1.6
     */
    public static final int MAX_EXPONENT = 1023; // double二进制形式指数部分最大值
     ...
     * @since 1.6
     */
    public static final int MIN_EXPONENT = -1022; // double二进制形式指数部分最大值
     ...
     * @serial
     */
    private final double value; // 当前类包装的值
    ...
    public static String toHexString(double d) {
        ...
        if(!isFinite(d))
            ...
            if(d == 0.0) {
                ...
                // Isolate significand bits and OR in a high-order bit so that the string representation has a known length.
                ...
                /*
                 * Isolate the low-order 13 digits of the hex representation.
                 * If all the digits are zero, replace with a single 0;
                 * otherwise, remove all trailing zeros.
                 */
                ...
                /*
                 * If the value is subnormal, use the E_min exponent value for double;
                 * otherwise, extract and report d's exponent (the representation of a subnormal uses E_min -1).
                 */
