...
public final class Math {
    ...
    public static double scalb(double d, int scaleFactor) {
        ...
        final int MAX_SCALE = Double.MAX_EXPONENT + -Double.MIN_EXPONENT + DoubleConsts.SIGNIFICAND_WIDTH + 1;
        int exp_adjust = 0;
    ...
    public static float scalb(float f, int scaleFactor) {
        ...
        // underflow; due to rounding, scaling down takes an
        // additional power of two which is reflected here
        final int MAX_SCALE = Float.MAX_EXPONENT + -Float.MIN_EXPONENT + FloatConsts.SIGNIFICAND_WIDTH + 1;
        ...
        switch(exp) {
            ...
            default:
                ...
                if(exp >= Float.MIN_EXPONENT) {
                    ...
                    // return a subnormal result;
                    // left shift integer representation of FloatConsts.MIN_VALUE appropriate number of positions
        ...
        switch(exp) {
            ...
            default:
                ...
                if(exp >= Double.MIN_EXPONENT) {
                    ...
                    // return a subnormal result;
                    // left shift integer representation of Double.MIN_VALUE appropriate number of positions
