...
| 阅读完成度 | 含义 |
| -------- | ---- |
| :full_moon: | 完成阅读，方法/字段已读完，实现过程已了解 |
| :waxing_gibbous_moon: | 完成阅读，方法/字段已读完，但一些实现细节未掌握 |
| :first_quarter_moon: | 正在阅读，方法/字段未读完，理解了大部分特性 |
| :waxing_crescent_moon: | 正在阅读，方法/字段未读完，只涉猎了一部分特性 |
| :new_moon: | 初步接触，有限的了解，大概知道该类的作用 |
...
* 引用
  ...
  * :full_moon: [**ReferenceQueue**](src/java/lang/ref/ReferenceQueue.java)
